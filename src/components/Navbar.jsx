  ...
  return (
    <nav className="navbar">
      ...
      <div className="nav-socials">
        ...
        <a href="https://github.com/cbmitchell" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="mailto:chrisbeckermitchell@gmail.com" aria-label="Email">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
